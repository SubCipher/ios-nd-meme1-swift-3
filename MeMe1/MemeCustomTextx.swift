...
class MemeCustomTextx: UIViewController  {
...
//MARK: - custom textField settings
    ...
    func createTextFields() ->(topTextField:UITextField, bottomTextField: UITextField){
        ...
        if isDeviceVertical == true {
            ...
            bottomCGRect = CGRect(x: 205.0, y: 260.0, width: 222.0, height: 42.0)
        }
    ...
    func textFieldSettings(textCGRect:CGRect, placeHolderText: String) ->UITextField {
